...
function Read() {
    ...
    if(names2!=null) {
        for(var i=0;i<names2.length;i++){
            userTR.innerHTML+=`
            <div class="card text-white bg-dark border border-success mb-2" style="max-width: 18rem;">
            <div class="card-body">
            <p><i class="fa fa-user"></i> User:${names2[i]}</p>
...
function Update(i3){
    ...
    for(var i=0;i<names4.length;i++){
        if(i==i3){
            userTR.innerHTML+=`
            <div class="card text-white bg-dark border border-danger mb-2" style="max-width: 18rem;">
            <div class="card-body">
